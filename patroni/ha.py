...
class Ha(object):
    ...
    def __init__(self, patroni: Patroni):
        ...
        self._leadership_expiry = 0
        self._leadership_expiry_lock = RLock()
    ...
    def is_leader(self) -> bool:
        with self._leadership_expiry_lock:
            return self._leadership_expiry > time.time()

    def set_is_leader(self, value: bool) -> None:
        with self._leadership_expiry_lock:
            self._leadership_expiry = time.time() + self.dcs.ttl if value else 0
