...
- Added support for custom Postgres binary names (Israel, Polina Bungina)
...
- Various improvements of ``patroni --validate-config`` (Polina)
...
- Fixed issue in Citus support (Alexander)
