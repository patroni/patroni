...
**DCS requirements**: Your DCS (etcd, ZooKeeper, Consul, Nomad) has to run with **3 or 5 nodes** for proper consensus and fault tolerance. A single DCS cluster can store information for hundreds or thousands of Patroni clusters using different namespace/scope combinations.
